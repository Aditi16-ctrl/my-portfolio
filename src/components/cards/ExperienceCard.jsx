...
const Image = styled.img` // Changed to img element
    height: 50px;
    border-radius: 10px;
    margin-top: 4px;
...
const Role = styled.div`
    font-size: 18px;
    font-weight: 600; // Corrected the syntax
...
const ItemWrapper = styled.div`
    display: flex; // Fixed from display flex to display: flex
    flex-wrap: wrap;
    gap: 8px;
`;

const EducationCard = ({ education: experience }) => {
    return (
